            ...
            <CameraExpo ratio="16:9" ref={ref => setCamera(ref)} flashMode={flashCamera} type={typeCamera} style={{height, width: '100%'}}>
                <Options>
                    ...
                    <Option style={{marginRight: 'auto'}} onPress={() => {
                        ...
                        <Svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="#0872FC" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
                    ...
                    <Option style={{marginLeft: 'auto', marginRight: 'auto'}} onPress={async () => setFoto(await camera.takePictureAsync())}>
                        <Svg xmlns="http://www.w3.org/2000/svg" width="66" height="66" fill="#0872FC" class="bi bi-circle" viewBox="0 0 16 16">
                    ...
                    <Option style={{}} onPress={() => {
                        ...
                        {flashCamera === CameraExpo.Constants.FlashMode.off ? <Svg xmlns="http://www.w3.org/2000/svg" height="46px" viewBox="0 0 24 24" width="46px" fill="#0872FC">
                            <Path d="M0 0h24v24H0V0z" fill="none"/>
                            <Path d="M17 10h-3.61l2.28 2.28zm0-8H7v1.61l6.13 6.13zm-13.59.86L2 4.27l5 5V13h3v9l3.58-6.15L17.73 20l1.41-1.41z"/>
                        </Svg> : <Svg xmlns="http://www.w3.org/2000/svg" height="46px" viewBox="0 0 24 24" width="46px" fill="#0872FC">
                            <Path d="M0 0h24v24H0V0z" fill="none"/>
